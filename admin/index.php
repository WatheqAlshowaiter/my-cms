      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo isset($_SESSION['username'])? $_SESSION['username']:"" ?> </li>
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <?php echo "<div class='mr-5'>{$comments_count} Comments!</div>"; ?>
                </div>
             ...
             <?php 
              // this is for couting categories  
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <?php echo "<div class='mr-5'>{$categories_count} Categories!</div>"; ?>
                </div>
              ...
              <div class="card text-white bg-success o-hidden h-100">
                <div class="card-body">
                  <div class="card-body-icon">
                   ...
                   <?php echo "<div class='mr-5'>{$users_count} Users!</div>"; ?>
                </div>
            ...
            <?php 
              // this is for couting posts  
              $posts_count = recordCount('users'); 
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <?php echo "<div class='mr-5'>{$posts_count} posts!</div>"; ?>
          ...
          <?php 
            // some additional columns 
              ...
              // $drafts_count = mysqli_num_rows($select_all_draft_query);

              $drafts_count = checkStatus('posts', 'post_status', 'draft'); 

              // published posts 
              // $query = "SELECT * FROM posts WHERE post_status ='published' ";
              // $select_all_published_query = mysqli_query($connection, $query); 
              $publisheds_count = checkStatus('posts', 'post_status', 'published'); 
             
              // unapprrovrd comments 
